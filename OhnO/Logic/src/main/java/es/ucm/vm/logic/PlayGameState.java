...
public class PlayGameState implements GameState{
    ...
    *//*----------------------------------------------------*/
    ...
    private void fillBoard(int mapSize) {
        ...
        _quit = (new BoardTile(step/2 - (smallSide / 4),                     -175, d, TileColor.GREY, 0, new BoardPosition(0, 0)));
        _quit.setTxt("Q");
        _quit.setCoordOrigin(_coordOr);
        _resetMove = new BoardTile(step/2 * (mapSize - 1) - (smallSide / 4),     -175, d, TileColor.GREY, 0, new BoardPosition(0, 0));
        _resetMove.setTxt("R");
        _resetMove.setCoordOrigin(_coordOr);
        _hintButton = new BoardTile(step * ((mapSize-1) - 0.5) - (smallSide / 4), -175, d, TileColor.GREY, 0, new BoardPosition(0, 0));
